...
function ViewRecipe({ navigation, recipeDetail }) {
    ...
    const saveRecipe = () => {
        ...
        var recipe = { id: recipeDetail.id, title: recipeDetail.title, url: recipeDetail.image};
    ...
    const shareRecipe = () => {
        ...
        var recipe = JSON.stringify({ id: recipeDetail.id, title: recipeDetail.title, url: recipeDetail.image});
        navigation.navigate("ShareRecipe", {props: recipe})
    }
                    ...
                    */
                    ...
                    <View style={styles.viewBoxStyle}>
                        <View style={{ flex: 1, alignItems: 'center', justifyContent: 'flex-start', flexDirection: 'row' }}>
                            <Button title="Save" onPress={() => saveRecipe()}></Button>
                            <View style={{margin: 10}}>
                            <Button title="Print"></Button>
                            </View>
                            <Button title="Share" onPress={() => shareRecipe()}></Button>
                        </View>
                    </View>
